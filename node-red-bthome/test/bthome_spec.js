...
describe( 'bthome Node', function () {
  ...
  it('should decode version messages', function (done) {
    let flow = [{ id:'flow', type:'tab' },
                { id: "n1", type: "bthome", name: "test", statusPrefix:"", devices:testDevices, batteryState:false, wires: [["n2"],["n3"]], z:"flow" },
                { id: "n2", type: "helper", z: "flow" },
                { id: "n3", type: "helper", z: "flow" }];
    helper.load(node, flow, async function () {
      let n1 = helper.getNode("n1");
  ...
  it('should decode unencrypted messages and device reboot (Shelly HT)', function (done) {
    let flow = [{ id:'flow', type:'tab' },
    ...
    helper.load(node, flow, async function () {
      ...
      try {
        ...
        n1.data.should.have.ValidData("dev_unencrypted_1",{},"2nd",{});
        c1.should.match( 1 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          addr:    "00:01:02:03:04:05",
        ...
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_2",{pid:54,encrypted:false},null,{temperature:-5.5,humidity:75,battery:94});
        c1.should.match( 2 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:54},null,{});
        c1.should.match( 2 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:1,encrypted:false},"UnitTest",{temperature:12.5,humidity:57,battery:94});
        c1.should.match( 3 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
  ...
  it('should decode unencrypted messages and resync (Shelly DW)', function (done) {
    let flow = [{ id:'flow', type:'tab' },
                { id: "n1", type: "bthome", name: "test", statusPrefix:"State", devices:testDevices, batteryState:false, wires: [["n2"],["n3"]], z:"flow" },
                { id: "n2", type: "helper", z: "flow" },
                { id: "n3", type: "helper", z: "flow" }];
    helper.load(node, flow, async function () {
      let n1 = helper.getNode("n1");
      ...
      n2.on("input", function (msg) {
        try {
          ...
          {
            case 1:
              msg.should.have.a.property('payload',{ lux: 660.51, state: true, tilt: 6 });
              break;
            case 2:
      ...
      try {
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:128,encrypted:false},"UnitTest",{lux:660.51,state:true,tilt:6});
        c1.should.match( 1 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:129,encrypted:false,battery:10},"UnitTest",{lux:660.51,state:false,tilt:6});
        n1.should.have.a.property('statistics',{ok:3,err:0,old:0,dup:0});
        c1.should.match( 2 );
        c2.should.match( 0 );
        n1.receive({ resync: true }); // resync
        await delay(50);
        n1.warn.should.have.callCount(1);
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:null,encrypted:false,battery:10},null,{lux:660.51,state:false,tilt:6});
        n1.should.have.a.property('statistics',{ok:3,err:0,old:0,dup:0});
        c1.should.match( 2 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          ...
          rssi:    -50,
          time:    Date.now(),
          data:    [68,0,128,5,0,0,0,0x2D,1,0x3F,0,0]
        } }); // next message
        await delay(50);
        n1.warn.should.have.callCount(1);
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:128,encrypted:false},"UnitTest",{lux:0,state:true,tilt:0});
    ...
    helper.load(node, flow, async function () {
      ...
      n2.on("input", function (msg) {
        try {
          c1++;
          msg.should.have.a.property('topic','State/dev_unencrypted_1');
          msg.should.have.a.property('payload',{ distance: c1==1?13330:801, vibration: c1==2, battery: c1==1?50:45 });
        }
        catch(err) {
          done(err);
        }
      ...
      try {
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:2,encrypted:false},"UnitTest",{distance:13330,vibration:false,battery:50});
        c1.should.match( 1 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:3,encrypted:false},"UnitTest",{distance:801,vibration:true,battery:45});
        n1.should.have.a.property('statistics',{ok:3,err:0,old:0,dup:0});
        c1.should.match( 2 );
        c2.should.match( 0 );
        done();
  ...
  it('should decode unencrypted messages (Shelly Weather)', function (done) {
    ...
    helper.load(node, flow, async function () {
      ...
      try {
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:2,encrypted:false},"UnitTest",{
          lux: 13460.67,
          moisture: true,
          wind: [ 11.02, 133.9 ],
          uv: 12.8,
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:3,encrypted:false,battery:45},"UnitTest",{
          lux: 13460.67,
          moisture: true,
          wind: [ 11.02, 133.9 ],
          uv: 12.8,
  ...
  it('should decode unencrypted events (Shelly Button)', function (done) {
    ...
    helper.load(node, flow, async function () {
      ...
      try {
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:4},"UnitTest");
        c1.should.match( 0 );
        c2.should.match( 2 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
    ...
    helper.load(node, flow, async function () {
      ...
      n2.on("input", function (msg) {
        ...
        try {
          ...
          {
            case 2:
              msg.should.have.a.property('payload',{button:"S"});
              break;
            case 4:
              msg.should.have.a.property('payload',{button:"L"});
              break;
            default:
              msg.should.have.a.property('payload',{button:""});
          }
        }
        catch(err) {
          done(err);
      ...
      try {
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:4},"UnitTest",{button:"L"});
        c1.should.match( 4 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:5},"UnitTest",{button:""});
        n1.should.have.a.property('statistics',{ok:6,err:0,old:0,dup:0});
        c1.should.match( 5 );
        c2.should.match( 0 );
        done();
  ...
  it('should decode unencrypted events (Shelly Button 4), state', function (done) {
    let flow = [{ id:'flow', type:'tab' },
    ...
    helper.load(node, flow, async function () {
        ...
        try {
          ...
          switch( c1 )
          {
            case 1:
              ...
              break;
            case 2:
              msg.should.have.a.property('payload',{button:["","SS","",""]});
              break;
            case 3:
              msg.should.have.a.property('payload',{button:["","","SSS",""]});
              break;
            case 4:
              msg.should.have.a.property('payload',{button:["","","","L"]});
              break;
      ...
      try {
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:1},"UnitTest",{button:['S','','','']});
        c1.should.match( 1 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:2},"UnitTest",{button:['','SS','','']});
        c1.should.match( 2 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:3},"UnitTest",{button:['','','SSS','']});
        c1.should.match( 3 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
  ...
  it('should decode unencrypted events (Shelly Remote)', function (done) {
    ...
    helper.load(node, flow, async function () {
      ...
      try {
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:1},"UnitTest",{channel:1});
        c1.should.match( 1 );
        c2.should.match( 1 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:2},"UnitTest",{channel:3});
        c1.should.match( 2 );
        c2.should.match( 2 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
        ...
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          ...
          rssi:    -50,
          time:    Date.now(),
          data:    [68,0,4,1,100,60,1,13,96,1]
        } });
        await delay(50);
        n1.warn.should.have.callCount(0);
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:4},"UnitTest",{channel:2});
        c1.should.match( 4 );
        c2.should.match( 3 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
          ...
          rssi:    -50,
          time:    Date.now(),
          data:    [68,0,5,1,100,60,2,9,96,3]
        } });
        await delay(50);
        n1.warn.should.have.callCount(0);
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:5},"UnitTest",{channel:4});
        c1.should.match( 5 );
        c2.should.match( 4 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
          ...
          rssi:    -50,
          time:    Date.now(),
          data:    [68,0,6,1,100,63,55,0,63,223,253,63,248,2,96,3]
        } });
        await delay(50);
        n1.warn.should.have.callCount(0);
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:6},"UnitTest",{channel:4});
        n1.should.have.a.property('statistics',{ok:7,err:0,old:0,dup:0});
        c1.should.match( 6 );
        c2.should.match( 5 );
        done();
      }
  ...
  it('should decode unencrypted events (Shelly Remote), state', function (done) {
    let flow = [{ id:'flow', type:'tab' },
                { id: "n1", type: "bthome", name: "test", eventState:true, devices:testDevices, wires: [["n2"],["n3"]], z:"flow" },
                { id: "n2", type: "helper", z: "flow" },
                { id: "n3", type: "helper", z: "flow" }];
    helper.load(node, flow, async function () {
      ...
      n2.on("input", function (msg) {
        try {
          ...
          {
            case 1:
              msg.should.have.a.property('payload',{button:['S',''],channel:1});
              break;
            case 2:
              msg.should.have.a.property('payload',{button:['','S'],channel:3});
              break;
            case 3:
              msg.should.have.a.property('payload',{button:['',''],channel:2,dimmer:0});
              break;
            case 4:
              msg.should.have.a.property('payload',{button:['',''],channel:2,dimmer:13});
              break;
            case 5:
              msg.should.have.a.property('payload',{button:['',''],channel:4,dimmer:-9});
              break;
            case 6:
              msg.should.have.a.property('payload',{button:['',''],channel:4,dimmer:0,rotation:[5.5,-54.5,76]});
              break;
            case 7:
              msg.should.have.a.property('payload',{button:['',''],channel:4,dimmer:0,rotation:[0,0,0]});
              break;
          }
        }
        catch(err) {
      ...
      try {
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:1},"UnitTest",{button:['S',''],channel:1});
        c1.should.match( 1 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:2},"UnitTest",{button:['','S'],channel:3});
        c1.should.match( 2 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
          ...
          rssi:    -50,
          time:    Date.now(),
          data:    [68,0,3,1,100,58,0,58,0,60,1,0,96,1]
        } });
        await delay(50);
        n1.warn.should.have.callCount(0);
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:3},"UnitTest",{button:['',''],channel:2,dimmer:0});
        c1.should.match( 3 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
          ...
          rssi:    -50,
          time:    Date.now(),
          data:    [68,0,4,1,100,58,0,58,0,60,1,13,96,1]
        } });
        await delay(50);
        n1.warn.should.have.callCount(0);
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:4},"UnitTest",{button:['',''],channel:2,dimmer:13});
        c1.should.match( 4 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:5},"UnitTest",{button:['',''],channel:4,dimmer:-9});
        c1.should.match( 5 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
          ...
          rssi:    -50,
          time:    Date.now(),
          data:    [68,0,6,1,100,63,55,0,63,223,253,63,248,2,96,3,60,0,0]
        } });
        await delay(50);
        n1.warn.should.have.callCount(0);
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:6},"UnitTest",{button:['',''],channel:4,dimmer:0,rotation:[5.5,-54.5,76]});
        c1.should.match( 6 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
          ...
          rssi:    -50,
          time:    Date.now(),
          data:    [68,0,7,1,100,63,0,0,63,0,0,63,0,0,96,3,60,0,0]
        } });
        await delay(50);
        n1.warn.should.have.callCount(0);
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_unencrypted_1",{pid:7},"UnitTest",{button:['',''],channel:4,dimmer:0,rotation:[0,0,0]});
        n1.should.have.a.property('statistics',{ok:8,err:0,old:0,dup:0});
        c1.should.match( 7 );
        c2.should.match( 0 );
        done();
      }
  ...
  it('should decode encrypted messages', function (done) {
    ...
    helper.load(node, flow, async function () {
      ...
      try {
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_encrypted_1",{pid:128,encrypted:true},"UnitTest",{lux:660.51,state:1,tilt:6});
        c1.should.match( 1 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_encrypted_2",{pid:255,encrypted:true},"UnitTest",{lux:660.51,state:0,tilt:0});
        n1.should.have.a.property('statistics',{ok:2,err:0,old:0,dup:0});
        c1.should.match( 2 );
        c2.should.match( 0 );
        done();
  ...
  it('should decode encrypted messages, counterMode==rising', function (done) {
    ...
    helper.load(node, flow, async function () {
      ...
      try {
        ...
        n1.error.should.have.callCount(0);
        n1.should.have.a.property('data' );
        n1.data.should.have.ValidData("dev_encrypted_1",{pid:128,encrypted:true,lastCounter:512},"UnitTest",{lux:660.51,state:1,tilt:6});
        c1.should.match( 1 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
        ...
        n1.error.should.have.callCount(1);
        n1.should.have.a.property('data' );
        n1.data.should.have.ValidData("dev_encrypted_1",{pid:128,encrypted:true,lastCounter:512},"",{lux:660.51,state:1,tilt:6});
        c1.should.match( 1 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",
        ...
        n1.error.should.have.callCount(1);
        n1.should.have.a.property('data');
        n1.data.should.have.ValidData("dev_encrypted_1",{pid:130,encrypted:true,lastCounter:513},"UnitTest",{lux:660.51,state:1,tilt:6});
        c1.should.match( 2 );
        c2.should.match( 0 );
        n1.receive({ topic:"Shelly2/NodeRed/bleraw", payload: {
          gateway: "UnitTest",

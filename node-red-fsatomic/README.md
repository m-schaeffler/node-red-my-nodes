...
|encoding|string| encoding, [only the encodings integrated into nodejs are possible](https://nodejs.org/api/buffer.html#buffers-and-character-encodings).
If set to `msg.encoding`, the encoding is taken from the input message.|

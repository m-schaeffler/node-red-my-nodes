...
describe( 'init-flow Node', function () {
  ...
  it('should set contest variable to a number', function (done) {
    var flow = [{ id: "n1", type: "init-flow", name: "contextVar", value:3.141592, valueType:"num" }];
    helper.load(node, flow, async function () {
      var n1 = helper.getNode("n1");
      try {
        n1.should.have.a.property('name', 'contextVar');
  ...
  it('should set contest variable to a boolean', function (done) {
    var flow = [{ id: "n1", type: "init-flow", name: "contextVar", value:true, valueType:"bool" }];
    helper.load(node, flow, async function () {
      var n1 = helper.getNode("n1");
      try {
        n1.should.have.a.property('name', 'contextVar');
  ...
  it('should set contest variable to a JSON', function (done) {
    var flow = [{ id: "n1", type: "init-flow", name: "contextVar", value:'{"foo":21,"bar":25}', valueType:"json" }];
    helper.load(node, flow, async function () {
      var n1 = helper.getNode("n1");
      try {
        n1.should.have.a.property('name', 'contextVar');
  ...
  it('should set contest variable to a empty object', function (done) {
    var flow = [{ id: "n1", type: "init-flow", name: "contextVar", value:"{}", valueType:"json" }];
    helper.load(node, flow, async function () {
      var n1 = helper.getNode("n1");
      try {
        n1.should.have.a.property('name', 'contextVar');

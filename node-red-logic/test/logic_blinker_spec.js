  ...
  it('should blink, off in on phase', function (done) {
    ...
    helper.load(node, flow, async function () {
      ...
      try {
        ...
        n1.should.have.a.property('configOutputFirst', "first");
        n1.should.have.a.property('configOutputOn', "on");
        n1.should.have.a.property('configOutputOff', "off");
        n1.should.have.a.property('configOutputLast', "last");
        n1.should.have.a.property('filter', false);
        n1.should.have.a.property('showState', false);
        await delay(50);
  ...
  it('should blink, without first message', function (done) {
    ...
    helper.load(node, flow, async function () {
      ...
      try {
        ...
        //n1.should.have.a.property('configOutputFirst', null);
        n1.should.have.a.property('configOutputOn', "on");
        n1.should.have.a.property('configOutputOff', "off");
        n1.should.have.a.property('configOutputLast', "last");
        n1.should.have.a.property('filter', false);
  ...
  it('should blink, without last message', function (done) {
    ...
    helper.load(node, flow, async function () {
      ...
      try {
        ...
        n1.should.have.a.property('configOutputOn', "on");
        n1.should.have.a.property('configOutputOff', "off");
        //n1.should.have.a.property('configOutputLast', null);
        n1.should.have.a.property('filter', false);
        n1.should.have.a.property('showState', false);
        await delay(50);
        n1.receive({ payload: 1 });
